...
// BUILDING BLOCK, could be moved inside dispatch! with @prefix trick.
// disp_1!(func, (rt_type1, [u32, iu64]), [(rt_type2, [i32, i64]), (rt_type3, [f32, f64])], (), (arg1, arg2))
// disp_1!(func, (rt_type2, [i32, i64]), [(rt_type3, [i32, i64])], (u32), (arg1, arg2))
// disp_1!(func, (rt_type3, [f32, f64]), [], (u32, i32), (arg1, arg2))
macro_rules! disp_expand {
    ($function:ident, ($rt_type:expr, [$($dispatch_type:ty),+]), $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        match $rt_type.descriptor.as_str() {
            $(stringify!($dispatch_type) => disp_1!($function, $rt_dispatch_types, $type_args, $dispatch_type, $args)),+,
            rt_type => panic!("No match for concrete type {}", rt_type)
        }
    };
}

// BUILDING BLOCK, could be moved inside dispatch! with @prefix trick.
// disp_recur!(func, [(rt_type2, [i32, i64]), (rt_type3, [f32, f64])], u32, (), (arg1, arg2))
// disp_recur!(func, [(rt_type3, [i32, i64])], i32, (u32), (arg1, arg2))
// disp_recur!(func, [], f32, (u32, i32), (arg1, arg2))
macro_rules! disp_1 {
